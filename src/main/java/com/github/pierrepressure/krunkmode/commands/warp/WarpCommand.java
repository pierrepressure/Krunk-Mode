...
public class WarpCommand extends CommandBase {
    private final boolean custom_command;
    public String name;
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        // Note: Removed Utils.inSkyblock check since it's not available in this mod
        // You can add your own skyblock detection logic here if needed
